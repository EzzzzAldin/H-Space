    ...
    <div class="row">
        <div class="col-md-3">
            <div class="align-items-center d-flex imageAndTitle justify-content-around position-relative">
                ...
                <div class="aboutTitle position-absolute">
                    About <br> US
                </div>
            </div>
        </div>
        <div class="col-md-9">
            <div class="aboutSectiontwo d-flex flex-column h-100 justify-content-center">
                ...
                <p class="2dis">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente, nisi nam amet aliquam rerum itaque
